...
type InstanceTab = "settings" | "upstream-proxies";
...
export default function InstanceLayout() {
  ...
  // The sidebar previously only ever rendered one tab, so the active item was
  // hardcoded. Derive it from the pathname now that there are two.
  const { pathname } = useLocation();
  const activeTab: InstanceTab = pathname.endsWith("/upstream-proxies")
    ? "upstream-proxies"
    : "settings";
